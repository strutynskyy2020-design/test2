...
const CACHE_PREFIX = "vpdk-google-reports-v120:";
const LEGACY_CACHE_PREFIX = "tm6-google-reports-v104:";
const STALE_CACHE_PREFIXES = ["vpdk-google-reports-v115:", "tm6-google-reports-v106:", LEGACY_CACHE_PREFIX];
const VERSION_ENDPOINT = "/.netlify/functions/google-goals-version";
const REPORTS_ENDPOINT = "/.netlify/functions/google-goals";
const DB_NAME = "vpdk-google-reports-v120";
const DB_VERSION = 1;
