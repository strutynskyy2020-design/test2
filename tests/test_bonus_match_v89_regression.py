"""Dependency-free regression checks for Bonus Match v89."""
...
def test_frontend_features_are_wired() -> None:
    ...
    assert 'if (restoreActiveSession && data.active_session)' in source
...
if __name__ == "__main__":
    ...
    print("Bonus Match v89 regression checks passed")
