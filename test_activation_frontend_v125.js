...
assert(cache.includes('vpdk-google-reports-v129:'), "Frontend cache version is not v129");
assert(serviceWorker.includes('const VERSION = "vpdk-v129"'), "Service Worker version is not v129");
