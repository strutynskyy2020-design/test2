# VPDK Bonus — актуальний пакет для Netlify, 10.09.2026
...
Цей архів містить вихідний код і не призначений для Netlify Drop.
Drop потребує зібраний frontend з index.html у корені і не виконує npm run build.
Серверні Netlify Functions розгортаються через Git, CLI або API.
Для готової frontend-збірки потрібна публічна адреса backend: локальний 127.0.0.1
